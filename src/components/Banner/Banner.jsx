          ...
          <div className="container">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 items-center">
              ...
              <div className="flex flex-col justify-center gap-6 sm:pt-0 lg:px-16">
                ...
                >
                   We're not just booking flights and hotels; we're crafting experiences that ignite your wanderlust and expand your horizons. We believe travel should be immersive, authentic, and tailored to your passions. Whether you're seeking adventure in the Amazon, cultural immersion in Europe, or relaxation on a tropical beach, we'll guide you every step of the way. We handle the logistics, so you can focus on creating memories that will last a lifetime. With us, you'll not just see the world, you'll truly experience it.
                  <br />
                </p>
